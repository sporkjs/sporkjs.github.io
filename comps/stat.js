...
comps[theComp][theType]=[
	...
	'\\item Which measure of center is the only one that is reliable in the sense that measures from samples tend to be close to the measure for the population?',
